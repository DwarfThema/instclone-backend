...
exports.default = {
    Photo: {
        ...
        likes: function (_a) {
            var id = _a.id;
            return client_1.default.like.count({ where: { photoId: id } });
        },
        commentNumber: function (_a) {
            var id = _a.id;
            return client_1.default.comment.count({ where: { photoId: id } });
        },
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, client_1.default.like.findUnique({
                                    where: {
                                        photoId_userId: {
                                            photoId: id,
    ...
    Hashtag: {
        ...
        totalPhotos: function (_a) {
            var id = _a.id;
            return client_1.default.photo.count({
                where: {
                    hashtags: { some: { id: id } },
                },
            });
