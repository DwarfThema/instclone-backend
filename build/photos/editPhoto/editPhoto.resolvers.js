...
var resolverFn = function (_, _a, _b) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, client_1.default.photo.findFirst({
                        where: {
                            id: id,
                ...
                case 1:
                    ...
                    return [4 /*yield*/, client_1.default.photo.update({
                            where: {
                                id: id,
                            },
                            data: {
...
var resolvers = {
    Mutation: {
        editPhoto: (0, users_utils_1.protectedResolver)(resolverFn),
    },
};
